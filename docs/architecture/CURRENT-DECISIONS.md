...
| --- | --- |
| [ADR-001](adr/ADR-001-first-party-monorepo.md) | Current. One first-party Cargo/pnpm workspace plus an isolated Signal SQLCipher worker, with locked dependencies and [package catalogue](../../ci/package-groups.json). Migration ledgers are archives. |
...
| [ADR-012](adr/ADR-012-rust-baseline-and-resolver.md) | Updated 2026-09-14: one root compiler pin for the main workspace and Signal worker. [Rust 1.95.0](../../rust-toolchain.toml), edition 2024, resolver 3, workspace lint inheritance. The state-buffer import is the narrow documented unsafe exception. |
