...
Accepted 2026-08-12 and simplified 2026-08-14.
...
one concrete artifact. GitHub may publish that artifact afterward, but GitHub
Actions is not required to create or test a candidate.
